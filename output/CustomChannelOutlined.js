...
const CustomChannelOutlined = (props) => {
...
CustomChannelOutlined.propTypes = {
  size: PropTypes.oneOf([16, 20, 24, 32]),
  weight: PropTypes.oneOf(["BOLD"]),
  fill: PropTypes.string,
};

CustomChannelOutlined.defaultProps = {
  size: 20,
  weight: "BOLD",
  fill: colors.iconDefault,
};

CustomChannelOutlined.displayName = "CustomChannelOutlined";

export default CustomChannelOutlined;
