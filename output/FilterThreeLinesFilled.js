...
const FilterThreeLinesFilled = (props) => {
...
FilterThreeLinesFilled.propTypes = {
  size: PropTypes.oneOf([16, 20, 24, 32]),
  weight: PropTypes.oneOf(["REGULAR", "BOLD"]),
  fill: PropTypes.string,
};

FilterThreeLinesFilled.defaultProps = {
  size: 20,
  weight: "BOLD",
  fill: colors.iconDefault,
};

FilterThreeLinesFilled.displayName = "FilterThreeLinesFilled";

export default FilterThreeLinesFilled;
